...
# source: worker/ffmpeg_worker.proto
...
FFmpegResponse = _reflection.GeneratedProtocolMessageType('FFmpegResponse', (_message.Message,), {
  ...
  '__module__' : 'worker.ffmpeg_worker_pb2'
